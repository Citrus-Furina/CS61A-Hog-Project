...
def free_bacon(score):
    ...
    # pi=mul(pow(10,score+1),pi)//10
    pi=pi//pow(10,100-score)%10+3
...
def swine_align(player_score, opponent_score):
    ...
    if player_score>0 and opponent_score>0:
        while c>=1: 
            if player_score%c==0 and opponent_score%c==0:
                if c>=10:
                    return True
            c=c-1
    return False
    ...
    def say(score0,score1):
        ...
        if who==0:
            if score0-last_score1>running_high1:
                ...
                print(running_high1,"point(s)! The most yet for Player 0")
            last_score1=score0
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    max=0
    while b<=10:
        a=make_averaged(roll_dice, trials_count)(b, dice)
        if a>max:
            max1=b
            max=a
        b=b+1
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    num_rolls=6
    cutoff=8
    if score-opponent_score>10 and num_rolls>0 and cutoff>0:
        num_rolls=num_rolls-1
        cutoff=cutoff-1
    if score-opponent_score<-10 and cutoff<12 and num_rolls<10:
        num_rolls=num_rolls+1
        cutoff=cutoff+1
